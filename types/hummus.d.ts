declare module 'hummus' {
    ...
    export function createWriter(input: FilePath | WriteStream, options?: PDFWriterOptions): PDFWriter;
    export function createWriterToModify(inFile: FilePath, options?: PDFWriterToModifyOptions): PDFWriter;
    export function createWriterToModify(inStream: ReadStream, outStream: WriteStream, options?: PDFWriterToModifyOptions): PDFWriter;
    ...
    export function recrypt(originalPdfPath: FilePath, newPdfPath: FilePath, options?: PDFRecryptOptions): void;
    ...
    export interface ResourcesDictionary {
      addFormXObjectMapping(formXObject: FormXObject): any; // FIXME: any
      /*
    ...
    */
    ...
    export interface DocumentCopyingContext {
      createFormXObjectFromPDFPage(sourcePageIndex: number, ePDFPageBox: PDFPageBoxType | PDFBox): number; // FIXME: find out what is that
  ...
  SET_PROTOTYPE_METHOD(t, "allocateNewObjectID", AllocateNewObjectID);
    ...
    export interface PDFWriter {
      ...
      */
      ...
      getFontForFile(inFontFilePath: FilePath, inOptionalMetricsFile?: string, index?: number): UsedFont;
      /*
